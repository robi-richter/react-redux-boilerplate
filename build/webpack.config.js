...
const webpackConfig = {
  ...
  resolve: {
    root: paths.base(config.clientDir),
    extensions: ['', '.js', '.jsx']
  },
  module: {}
};
...
webpackConfig.output = {
  filename: `[name].[${config.compiler.hashType}].js`,
  path: paths.base(config.distDir),
...
if (config.compiler.cssModules) {
  PATHS_TO_TREAT_AS_CSS_MODULES.push(
    paths.base(config.clientDir).replace(/[\^\$\.\*\+\-\?\=\!\:\|\\\/\(\)\[\]\{\}\,]/g, '\\$&')
  );
}
